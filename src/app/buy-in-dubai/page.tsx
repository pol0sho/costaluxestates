        ...
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
            <div className="prose prose-lg mx-auto">
                ...
                <div className="my-12 flex justify-center">
                    <Image src="/dubai.jpg" alt="Buy in Dubai and surroundings" width={800} height={400} className="rounded-lg shadow-md" data-ai-hint="Buy in Dubai and surroundings" />
                </div>
                ...
                <div className="my-12 flex justify-center">
                     <Image src="/dubai2.jpg" alt="Buy in Dubai and surroundings" width={800} height={400} className="rounded-lg shadow-md" data-ai-hint="handshake deal" />
                </div>
